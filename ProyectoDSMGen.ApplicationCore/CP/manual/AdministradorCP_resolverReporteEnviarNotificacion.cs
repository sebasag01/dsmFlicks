...
public void ResolverReporteEnviarNotificacion (int p_oid)
{
        ...
        try
        {
                ...
                foreach (ReporteEN reporte in listaReportes) {
                        ...
                        reporte.Estado = ProyectoDSMGen.ApplicationCore.Enumerated.Flicks.EstadoReporteEnum.resuelto; // fully qualified
                        ...
                        NotificacionEN notificacion = new NotificacionEN (){
                                Mensaje = mensaje,
                                Fecha = DateTime.Now,
                                TipoNotificacion = ProyectoDSMGen.ApplicationCore.Enumerated.Flicks.TipoNotificacionEnum.reporte,
                                IdOrigen = reporte.Id //,
