...
{
public partial class ReporteCP : GenericBasicCP
{
public ReporteCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public ReporteCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
